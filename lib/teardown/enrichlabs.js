...
export const enrichlabs = {
  ...
  /* The competitor index: the same funnel lenses, scored across the set.
     Illustrative demo figures, not measured. `teardown` is when a rival's own
     teardown last ran; null means it hasn't been run yet. */
  competitors: {
    refreshedAt: "Jul 30, 2026",
    rows: [
      { name: "Enrich Labs", self: true, timeToValue: "6 min", friction: 5, aha: 44, price: "$99/mo", trial: "3-day trial, no card", teardown: "Jul 30" },
      { name: "Jasper", timeToValue: "3 min", friction: 4, aha: 62, price: "$49/mo", trial: "7-day trial, card", teardown: "Jul 28" },
      { name: "Copy.ai", timeToValue: "2 min", friction: 3, aha: 58, price: "Free · $49/mo", trial: "Free plan", teardown: "Jul 28" },
      { name: "Writesonic", timeToValue: "2 min", friction: 3, aha: 55, price: "Free · $20/mo", trial: "Free plan", teardown: null },
      { name: "Surfer SEO", timeToValue: "9 min", friction: 6, aha: 50, price: "$99/mo", trial: "7-day refund", teardown: null },
      { name: "Okara AI", timeToValue: "4 min", friction: 4, aha: 60, price: "$29/mo", trial: "3-day trial", teardown: "Jul 29" },
    ],
  },
  ...
  lastTestRun: { card: "EC-01", result: "+50%", metric: "trial starts", date: "Aug 12, 2026" },
